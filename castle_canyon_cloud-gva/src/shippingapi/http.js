...
const Logging = require('cccommon/logging').logger('shippingapi');
Logging.enable();
...
exports.addRoutes = (app) => {
  ...
  routeDefs = routeDefs.concat(require('./route/sensordata').getRoutes());
  routeDefs = routeDefs.concat(require('./route/session').getRoutes());
  routeDefs = routeDefs.concat(require('./route/shipments').getRoutes());
  routeDefs = routeDefs.concat(require('./route/gateway').getRoutes());
 ...
 */
exports.getConfig = () => {
  return Commonconfig.shippingapi.http();
};
